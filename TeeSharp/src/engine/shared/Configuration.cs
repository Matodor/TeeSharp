...
namespace TeeSharp
{
    ...
    public class ConfigStr
    {
        ...
        public ConfigStr(string name, string scriptName, int maxLen, string def, int flags, string desc)
        {
            Name = name;
            ScriptName = scriptName;
            MaxLen = maxLen;
    ...
    public partial class Configuration : ISingleton
    {
        public const int
            CFGFLAG_SAVE = 1,
            CFGFLAG_CLIENT = 2,
        ...
        private readonly Dictionary<string, object> _configVariablesDictionary = new Dictionary<string, object>
        {
            ...
            { "SvName", new ConfigStr("SvName", "sv_name", 128, "TeeSharp server", CFGFLAG_SERVER, "Server name") },
            ...
            { "SvMaxClients", new ConfigInt("SvMaxClients", "sv_max_clients", 64, 1, Consts.MAX_CLIENTS, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server") },
            { "SvMaxClientsPerIP", new ConfigInt("SvMaxClientsPerIP", "sv_max_clients_per_ip", 2, 1, Consts.MAX_CLIENTS, CFGFLAG_SERVER, "Maximum number of clients with the same IP that can connect to the server") },
